  ...
  return (
    <div className="privacy-policy p-6 max-w-3xl mx-auto">
      ...
      <p>
        ...
        privacy and only use your information to enhance your experience on our
        platform.
      </p>
      ...
      <p>
        ...
        improve the user experience, and provide personalized services. Data may
        also be used to troubleshoot issues, communicate updates, and analyze
        usage trends. Your data is used exclusively to support and enhance our
      ...
      <p>
        ...
        By using our service and submitting your data, you consent to our use of
        this information, including actions we may take to improve, modify, or
        personalize our services. While we take reasonable measures to secure
        your data, please be aware that there may be instances where data could
        become inaccessible, lost, or otherwise unavailable.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-3">4. Retention of Data</h2>
      <p>
        We will retain your personal data only for as long as is necessary for
        the purposes set out in this Privacy Policy. We will retain and use your
        data to the extent necessary to comply with legal obligations, resolve
        disputes, and enforce our agreements.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-3">5. Transfer of Data</h2>
      <p>
      ...
      <p>
        While data protection laws in the United States vary, certain rights may
        be available to you depending on your state of residence. For instance,
        under the California Consumer Privacy Act (CCPA), California residents
        have specific data protection rights, including the right to access,
        update, or delete the personal information we hold about them.
      ...
      <p>
        ...
        contact details provided in our application. Note that the availability
        of these rights may depend on your location and applicable state laws.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-3">7. Security of Data</h2>
      <p>
        We take the security of your data seriously and implement reasonable
        measures to protect your information. However, no method of transmission
      ...
      <p>
        ...
        consulting with a legal professional to ensure that your Privacy Policy
        complies with all relevant privacy laws and regulations.
      </p>
    </div>
  );
};
